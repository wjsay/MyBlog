<%@ Page Title="随笔" Language="C#" AutoEventWireup="true" CodeBehind="InformalEssay.aspx.cs" Inherits="MyBlog.InformalEssay" %>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="example-navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="InformalEssay" title="writing">随笔<span class="badge">5</span></a> </li>
					...
					<div class="col-xs-8">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$
                            ...
                            type, passage.time, passage.del
                                from passage, account where passage.aid = account.aid and type = 2 order by time desc"
