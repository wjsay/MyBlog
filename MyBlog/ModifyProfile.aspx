<%@ Page Title="修改个人信息" Language="C#" AutoEventWireup="true" CodeBehind="ModifyProfile.aspx.cs" Inherits="MyBlog.ModifyProfile" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div style="margin-left: 160px; font-size:medium">
            昵称：<input runat="server" id="Text1" type="text" /><br />
            原始密码：<input runat="server" id="Text0" type="password" /><br />
            新密码：<input runat="server" id="Text2" type="password" /><br />
