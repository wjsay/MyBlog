...
<body>
    ...
    <form id="form1" runat="server">
        <div style="margin-left: 280px">
            ...
            <br />
            <br />
&nbsp;<asp:Login ID="Login1" runat="server" BackColor="#F7F6F3" BorderColor="#E6E2D8" BorderPadding="4" BorderStyle="Solid" BorderWidth="1px" Font-Names="Verdana" Font-Size="0.8em" ForeColor="#333333" Height="254px" OnAuthenticate="Login1_Authenticate" style="margin-left: 0px" Width="335px">
